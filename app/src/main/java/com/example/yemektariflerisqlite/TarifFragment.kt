...
class TarifFragment : Fragment() {
    ...
    fun kaydet(view: View) {
        ...
        if (secilenBitmap != null) {
            ...
            //kayıt işlemi bittikten sonra listeye tekrar dönme
    ...
    //******Galeriden Görsel Alma  -- AndroidManifest.xml dosyasına izin yazıldı
    ...
    override fun onRequestPermissionsResult(
        requestCode: Int,  //istek kodu yukarıda 1 olarak verdik (gorselSec fonksiyonu içerisinde)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 2 && resultCode == Activity.RESULT_OK && data != null) {
            ...
            //seçilen görsel telefonda nerede almış olduk
            secilenGorsel = data.data
            //konumdaki dosya bitmap'e çevrilecek
            try {
                context?.let {
                    if (secilenGorsel != null) {
                        //telefon sdk 28 den eşit büyük mü kontrol
    ...
    //1mb dan büyük görselleri sqlite'a kaydetmek için küçültme
